...
export default function ReportsPage() {
  ...
  const REPORT_OPTIONS: { type: ReportType; label: string; description: string }[] = [
    { type: "sales", label: t("sales"), description: "Fichiers des ventes effectuées avec totaux" },
    { type: "inventory", label: t("inventory"), description: "Niveaux de stock et valeur marchande" },
    { type: "customers", label: t("customers"), description: "Balances clients et crédits en cours" },
    { type: "profit", label: t("reports"), description: "Bénéfice net et rapport des charges" },
  ];
  ...
  return (
    <ModulePage title={t("reportsTitle")} description={t("reportsSub")}>
